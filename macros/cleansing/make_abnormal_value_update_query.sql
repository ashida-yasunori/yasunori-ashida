...
select
	t1.store_id as store_id, t1.log_id as log_id, t1.item_index as item_index, t1.unit as unit, t1.aggregation_mode as aggregation_mode, null as value, t1.value_at as value_at, t1.created_at
    -- t1.store_id, t1.log_id, t1.item_index, t1.unit, t1.aggregation_mode, null as value, t1.value_at
from {{ ref('tbl_mart_abnormal_value') }} t1 
